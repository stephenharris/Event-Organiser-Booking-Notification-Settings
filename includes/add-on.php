...
class EO_Extension_eobns extends EO_Extension{

	public $slug       = 'event-organiser-eobns/event-organiser-eobns.php';
	public $public_url = 'http://wp-event-organiser.com/extenstion/event-organiser-eobns';
	public $label      = 'Event Organiser Booking Notification Settings';
	public $id         = 'eventorganiser_eobns';
	...
	public $dependencies = array(
		...
		'event-organiser-pro/event-organiser-pro.php' => array(
			'name' 		=> 'Event Organiser Pro',
			'version' 		=> '1.5.0',
			'install_slug' 	=> 'event-organiser-pro',
			'url' 			=> 'http://wp-event-organiser.com/pricing',
		),
	); 
}

$extension = new EO_Extension_eobns();
?>
